import "./filterCallsCall.scss";
import { useState } from "react";

export default function FilterCallsCall() {
  const [label, setLabel] = useState("Все звонки");
  ...
  return (
    <div className="filter-calls-call">
      <div className="filter-calls-call__button">
      ...
      <div className="filter-calls-call__list">
        ...
        <div onClick={handleTarget} className="list__item yellow-dot">
          Новые клиенты
        </div>
        <div onClick={handleTarget} className="list__item">
          Все исполнители
