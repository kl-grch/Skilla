...
import {
  ...
  RatingStatusGood,
  RatingStatusGreat,
} from "../ratingStatus/RatingStatus";
import { GreenDots, GreyDots, RedDots } from "../dotsColor/DotsColor";

export default function FilterCallsRate() {
  const [label, setLabel] = useState("Все оценки");

  const handleTarget = (e) => {
    setLabel(e.target.innerText);
  };
  return (
    <div className="filter-calls-rate">
      <div className="filter-calls-rate__button">
      ...
      <div className="filter-calls-rate__list">
