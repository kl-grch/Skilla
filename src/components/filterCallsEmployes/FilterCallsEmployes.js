import "./filterCallsEmployes.scss";
import { useState } from "react";

export default function FilterCallsEmployes() {
  const [label, setLabel] = useState("Все сотрудники");

  const handleTarget = (e) => {
    setLabel(e.target.innerText);
  };
  return (
    <div className="filter-calls-employes">
      <div className="filter-calls-employes__button">
